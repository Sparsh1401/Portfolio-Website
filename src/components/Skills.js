    ...
    return (
        <div className="skills">
            ...
            <div className="skillsGrid">
                ...
                <Skill source ="https://raw.githubusercontent.com/devicons/devicon/v2.15.1/icons/java/java-original-wordmark.svg" alt = "The logo icon for Java" title = "Java"/>
                ...
                <Skill source="https://raw.githubusercontent.com/devicons/devicon/v2.15.1/icons/graphql/graphql-plain.svg" alt="The logo icon for GraphQL" title="GraphQL"/>
                <Skill source="https://raw.githubusercontent.com/devicons/devicon/v2.15.1/icons/yarn/yarn-original-wordmark.svg" alt="The logo icon for Yarn" title="Yarn"/>
            </div>            
        </div>
    )
}
